        ...
        with self.engine.begin() as conn:
            ...
            upsert_query = text("""
                INSERT INTO insights_meta_ads (
                    id_anuncio, data_registro, account_id, nome_conta, id_campanha, campanha,
                    id_conjunto_anuncios, conjunto_anuncios, anuncio, plataforma, posicionamento, valor_gasto, impressoes,
                    cliques_saida, clique_link, lp_view, lead_formulario, lead_site, lead_mensagem, lead,
                    contato, conversas_iniciadas, novos_contatos_mensagem,
                    seguidores_instagram, visitas_perfil, initiate_checkout, compras, valor_compra,
                    videoview_3s, videoview_50, videoview_75,
                    hash_id, raw_data
                )
                SELECT
                    id_anuncio,
                    CAST(data_registro AS DATE),
                    account_id, nome_conta, id_campanha, campanha,
                    id_conjunto_anuncios, conjunto_anuncios, anuncio, plataforma, posicionamento,
                    CAST(valor_gasto AS NUMERIC),
                    impressoes, cliques_saida, clique_link, lp_view, lead_formulario, lead_site, lead_mensagem, lead,
                    contato, conversas_iniciadas, novos_contatos_mensagem,
                    seguidores_instagram, visitas_perfil, initiate_checkout, compras, CAST(valor_compra AS NUMERIC),
                    videoview_3s, videoview_50, videoview_75,
                    hash_id,
                ...
                ON CONFLICT (hash_id) DO UPDATE SET
                    ...
                    cliques_saida = EXCLUDED.cliques_saida,
                    clique_link = EXCLUDED.clique_link,
                    lp_view = EXCLUDED.lp_view,
                    ...
                    novos_contatos_mensagem = EXCLUDED.novos_contatos_mensagem,
